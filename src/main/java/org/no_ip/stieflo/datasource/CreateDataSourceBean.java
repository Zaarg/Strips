package org.no_ip.stieflo.datasource;
...
public class CreateDataSourceBean {
	...
	DataSource dataSource() {
		...
		if (environment.containsProperty("OPENSHIFT_MYSQL_DB_HOST")) { 	// uitvoering op OpenShift 
	...
	@Bean
        DataSource dataSource() {
            return new JndiDataSourceLookup().getDataSource("jdbc/stielostrips");
        }
